    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                ...
                <a href="<?= base_url('operator/tambah_alat'); ?>" class="btn btn-success mb-2">+ Tambah Data</a>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $val) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('operator/edit_alat/') . $val['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="color-blue bi bi-pencil-square" viewBox="0 0 16 16">
