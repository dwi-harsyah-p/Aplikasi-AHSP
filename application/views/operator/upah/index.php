                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $val) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('operator/edit_upah/') . $val['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="color-blue bi bi-pencil-square" viewBox="0 0 16 16">
